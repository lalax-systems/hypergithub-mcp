...
import (
	...
	"github.com/lalax-systems/hypergithub-mcp/internal/ghmcp"
	"github.com/lalax-systems/hypergithub-mcp/pkg/github"
...
var (
	rootCmd = &cobra.Command{
		Use:     "server",
		Short:   "HyperGitHub MCP Server",
		Long:    `A HyperGitHub MCP server with extended tools including repository deletion.`,
